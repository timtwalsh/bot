from .card_datastore import CardDatabase
...
def print_all_cards():
    ...
    """
    db = CardDatabase(CARD_DATA_TEMPLATES)
    ...
    for category, cards_in_category in db.card_data.items():
        ...
        for card_name in cards_in_category:
            ...
            card_instance = db.create_card_instance(category, card_name)
