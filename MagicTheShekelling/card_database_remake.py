...
class Card:
    ...
    def get_brief(self):
        ...
        return f"{rarity_icon}{self.name} ({self.attack}/{self.health}, {self.armor}a/{self.barrier}b) ${self.value}"
...
class CardDatabase:
    ...
    def generate_card_data(self):
        ...
        """
        self.card_data = CARD_DATA_TEMPLATES
